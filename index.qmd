...
One of the most venerable traditions of academia is to include a page drily listing the [scholarly](https://scholar.google.com/citations?user=QPH_lRIAAAAJ) books and journal publications for which one is to be held responsible. One presumes that this tiresome practice establishes one's credentials to one's peers, who will dutifully stare at the wall of text and be impressed by the overwhelming boredom it inspires. Though I no longer darken the doorsteps of the academic world, I have not quite abandoned the practice of self-archiving my work. The listing is fairly complete from 2016 onwards, but for earlier years only a subset of the papers is included. People who know why I left academia can probably guess the reason for the omissions.
