...
Back when I was part of that world, my academic research investigated how people learn, reason, and make choices in an uncertain world. It touched on topics in cognition, machine learning, statistics, visual perception, data visualisation, language, cultural evolution, cognitive development, and forensic psychology (I know, it's a weird mix...). To spare the casual reader the dull exercise of reading the whole thing I've featured few favourite projects below, but you're welcome to browse through the more-complete list if you feel sufficiently masochistic.
...
- Ben Yehuda, M., Murphy, R. A., Le Pelley, M. E., Navarro, D. J., Yeung, N. (in press). Confidence regulates feedback processing during human probabilistic learning. To appear in *Journal of Experimental Psychology: General*
